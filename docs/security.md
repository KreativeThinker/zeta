...
| **No relay for double-NAT peers** | Peers that cannot punch through NAT to each other directly have no relay path (DERP/TURN equivalent is not yet implemented). |
